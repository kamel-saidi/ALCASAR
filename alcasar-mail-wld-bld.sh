...
if [ $Lang == "fr" ]
then
	header_title="	              Configuration de la white/black list du domaine MX \n\n"
	...
	header_msg3=" La liste noire (Black List Domains BLD) limite les inscriptions utilisateurs à un ou plusieurs domaines."
	...
	bldNewD="Entrez le nom de domaine à bannir (ex : gmail.com, hotmail.fr...) : "
	addOther="Voulez vous ajouter un autre domaine ? (o/n) : "
else 
	header_title="	              Configuration of the white/black list MX domain \n\n"
	...
	header_msg3=" The black list (Black List Domains BLD) prohibits users registrations from one or more domains."
