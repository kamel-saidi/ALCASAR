...
##    - 2 service mail qui relaie les couriels sortant vers un autre serveur mail					    ##
...
##   - -a pour le mail de l'admin, reception des log, et mail lors de nouvelles inscriptions.			    ##
##															    ##
...
# on peut poser la question à l'admin s'il veut l'activer avant, dans ce cas le mettre avec la condition pour la WLD/BLD
...
# il n'est pas lancé en mode options, si la WLD/BLD existe en options, elle sera injéctée dans le fichier de conf direct
