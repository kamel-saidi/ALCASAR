...
# on peut désinstaller le SALS, mais c'est un mécanisme d'authentification qui peut être utilisé,
# il ne prend peut d'espèces disque, et si on le laisse ça évite de le télécharger pour un futur nstall, économisé le débit pour certains pays???
